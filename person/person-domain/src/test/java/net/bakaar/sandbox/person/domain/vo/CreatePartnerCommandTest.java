...
public class CreatePartnerCommandTest {
    ...
    public void of_should_set_the_madatory_value() {
        ...
        //When
        CreatePartnerCommand createdCommand = CreatePartnerCommand.of(name, forename, birthDate);
        //Then
    ...
    public void mandatory_fields_should_be_set(String name, String forename, @Param(converter = LocalDateConverter.class) LocalDate birthDate, String fieldName) {
        //When
        Throwable thrown = catchThrowable(() -> CreatePartnerCommand.of(name, forename, birthDate));
        //Then
